...
class GroupFieldsController extends AdminBaseController
{
    ...
    public function store(GroupFieldRequest $request)
    {
        ...
        flash()->success(trans('core::core.messages.resource created', ['name' => trans('dynamicfield::fields.title.fields')]));
    ...
    public function update(Group $group, Request $request)
    {
        ...
        flash()->success(trans('core::core.messages.resource updated', ['name' => trans('dynamicfield::fields.title.fields')]));
    ...
    public function destroy(Group $group)
    {
        ...
        flash()->success(trans('core::core.messages.resource deleted', ['name' => trans('dynamicfield::fields.title.fields')]));
